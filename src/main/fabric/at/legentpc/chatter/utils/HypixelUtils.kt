package at.legentpc.chatter.utils
...
object HypixelUtils : Module("HypixelUtils", needsToggle = false) {
    ...
    private fun onWorldChange() {
        ...
        ChatterEvents.WORLD_CHANGE.invoker().onWorldChange()
    }
    ...
    private fun updateIsland(newIsland: IslandType) {
        ...
        ChatterEvents.ISLAND_CHANGE.invoker().onIslandChange(newIsland, oldIsland)
    }
}
